 ...
 * @since 2019-05-01
 **/
public class DPXImageTransferCharacteristicRule implements IFileValidationRule {
	...
	public DPXImageTransferCharacteristicRule(DPXColumn column, int imageElement) {
