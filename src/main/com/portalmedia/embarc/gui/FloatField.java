...
/**
 * Data field for displaying floating point values
 *
 * @author PortalMedia
 * @version 1.0
 * @since 2018-05-08
 */
public class FloatField extends AnchorPane implements IEditorField {
	@FXML
	private FloatInputControl editorTextField;
	@FXML
