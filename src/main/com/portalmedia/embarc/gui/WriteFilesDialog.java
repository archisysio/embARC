 ...
 * @since 2018-05-08
 */
public class WriteFilesDialog extends AnchorPane {
	String filePath;
	String csvPath;
	...
	private void writeFiles(String filePath, String csvPath) {
		...
		final Task<Void> task = new Task<Void>() {
			...
			public Void call() {
				...
				final Cursor<FileInformationViewModel> fileList = DPXFileListHelper.getAllFiles(writeEditedOnly);
				...
				for (final FileInformationViewModel file : fileList) {
					try {
